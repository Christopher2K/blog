...
it a point to only associate myself with projects and concepts that I find
cool, and that I could personally use. CodeCrafters is that kind of product.
It's simple, it's cool, and it STIMULATES me. Here's my experience with this
...
Some people use them out of curiosity, while others see these platforms as a
way to prove how incredible they are as developers.
...
The experience is SUPER enjoyable: there is a Discord server for support
(that’s cool to have that, because we never know!) and the maintainers
regularly add new challenges!
...
things that happen, how many of us have already killed a production server,
huh?
...
- You can test the DNS challenge for free. [Use my link (sponsored, hehe 🤑💰)
  to sign up](https://app.codecrafters.io/join?via=Christopher2K). If you ever
  decide to switch to the paid version, you'll get a 40% discount!
